...
<div class="container">
    <div class="col-md-7">
        ...
        <p>
           Welcome to HestaMail
            ...
            <p id="text1">Connected With HestaMail </p>
            
            <div class="laptop">
                <img src="images/brainDots.png" class="img-responsive" id="gmail">
            </div>
    ...
    <section id="sign_section">
        ...
        <div class="panel panel-success signpanel-">
            ...
            <div class="panel-body">
                ...
                <form method="post" id="myform">
                    ...
                    <div class="form-group policy">
                        <p> Agree with our <a href="#"> terms and conditions</a></p>
